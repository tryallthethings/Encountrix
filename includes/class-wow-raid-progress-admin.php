	...
	public function enqueue_admin_assets($hook) {
		...
		wp_localize_script('wow-raid-progress-admin', 'wow_raid_admin', [
			...
			'strings' => [
				...
				'unknown_error' => __('Unknown error', 'wow-raid-progress'),
				...
				'no_api_key_continue' => __('No API key is set. The plugin will not be able to fetch raid data. Continue anyway?', 'wow-raid-progress'),
				'unsaved_changes' => __('You have unsaved changes. Are you sure you want to leave?', 'wow-raid-progress'),
				'settings_saved' => __('Settings saved successfully!', 'wow-raid-progress'),
				'select_raid_placeholder' => __('-- Select a Raid --', 'wow-raid-progress'),
				'error_loading_raids' => __('Error loading raids', 'wow-raid-progress'),
				'failed_load_raids' => __('Failed to load raids', 'wow-raid-progress'),
				'raids_refreshed_success' => __('Raids refreshed successfully!', 'wow-raid-progress'),
				'failed_refresh_raids' => __('Failed to refresh raids', 'wow-raid-progress'),
				'configure_blizzard_api_first' => __('Please configure Blizzard API credentials first', 'wow-raid-progress'),
				'select_raid_first' => __('Please select a raid first', 'wow-raid-progress'),
				'importing' => __('Importing...', 'wow-raid-progress'),
				'deleting' => __('Deleting...', 'wow-raid-progress'),
				'starting_import' => __('Starting import process...', 'wow-raid-progress'),
				'import_complete' => __('Import Complete!', 'wow-raid-progress'),
				'failed_delete_icons' => __('Failed to delete icons', 'wow-raid-progress'),
				'failed_clear_cache' => __('Failed to clear cache', 'wow-raid-progress'),
				'invalid_guild_ids' => __('Invalid guild IDs:', 'wow-raid-progress'),
				'guild_ids_numeric' => __('Guild IDs must be numeric.', 'wow-raid-progress'),
				'max_guild_ids' => __('Maximum 10 guild IDs allowed.', 'wow-raid-progress'),
				'realm_too_long' => __('Realm name is too long (max 50 characters).', 'wow-raid-progress'),
				'cache_time_invalid' => __('Cache time must be between 0 and 1440 minutes.', 'wow-raid-progress'),
				'limit_invalid' => __('Results limit must be between 1 and 100.', 'wow-raid-progress'),
				'please_fix_errors' => __('Please fix the following errors:', 'wow-raid-progress'),
				'dismiss_notice' => __('Dismiss this notice.', 'wow-raid-progress'),
				'log_cleared' => __('Log cleared', 'wow-raid-progress'),
				'no_log_entries' => __('No log entries', 'wow-raid-progress'),
